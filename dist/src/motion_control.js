...
import { startMotionCmd, stopMotionCmd, setSpeedCmd, setDirectionCmd, setSubdivideCmd, } from "./api_codes.js";
/**
 * 5.1 Start
 * @param {number} motor
 * @param {number} mode
 ...
 * @returns {Object}
 */
export function startMotion(motor, mode, mStep, speed, direction, pulse, accelStep) {
