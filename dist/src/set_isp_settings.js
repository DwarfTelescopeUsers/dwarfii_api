...
import { telephotoCamera, setExposureModeCmd, setExposureValueCmd, setGainModeCmd, setGainValueCmd, IRCut, setIRCmd, autofocusArea, autofocusCmd, setBrightnessValueCmd, setContrastValueCmd, setSaturationValueCmd, setHueValueCmd, setSharpnessValueCmd, setWhiteBalanceModeCmd, setWhiteBalanceScenceCmd, whiteBalanceScenesValueID, setWhiteBalanceColorCmd, modeManual, } from "./api_codes.js";
/**
 * 3.3.1 brightness
 * @param {number} camera
 * @param {number} value
 ...
 * @returns {Object}
 */
export function autoFocus(camera = telephotoCamera, mode = autofocusArea, x = 0, y = 0) {
    // centerX: 0-1920
    // centerY: 0-1080
    const options = {
 ...
 * @returns {Object}
 */
export function setWhiteBalanceMode(camera = telephotoCamera, mode = modeManual) {
    const options = {
 ...
 * @returns {Object}
 */
export function setWhiteBalanceScene(mode = whiteBalanceScenesValueID["incandescent lamp"]) {
    const options = {
