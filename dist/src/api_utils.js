...
export function analysePacket(message_buffer) {
    ...
    if (WsPacket_message.type == 2) {
        ...
        ResNotifyStateAstroGoto_message = decodePacket(WsPacket_message.data, $root.ResNotifyStateAstroGoto);
        console.log(`receive request response data >> ${ResNotifyStateAstroGoto_message.state}`);
