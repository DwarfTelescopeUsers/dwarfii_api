...
export function analyzePacket(message_buffer) {
    ...
    console.log(`receive message.majorVersion = ${WsPacket_message.majorVersion}`);
    console.log(`receive message.minorVersion = ${WsPacket_message.minorVersion}`);
    ...
    if (WsPacket_message.type == 0) {
        // Request
        console.log(`Decoding Request Frame => ${Dwarfii_Api.DwarfCMD[WsPacket_message.cmd]}`);
        ...
        Response_message = new Dwarfii_Api.ResNotifyStateAstroGoto();
        Response_message = decodePacket(WsPacket_message.data, Dwarfii_Api.ResNotifyStateAstroGoto);
        ...
        // Response
        console.log(`Decoding Response Request Frame => ${Dwarfii_Api.DwarfCMD[WsPacket_message.cmd]}`);
        console.log(`responseClass: ${responseClass}`);
        ...
        // Notification
        console.log(`Decoding Notification Frame => ${Dwarfii_Api.DwarfCMD[WsPacket_message.cmd]}`);
        console.log(`notifyClass: ${notifyClass}`);
        ...
        console.log(`Decoding Notification Response Frame => ${Dwarfii_Api.DwarfCMD[WsPacket_message.cmd]}`);
        console.log(`responseClass: ${responseClass}`);
        data_class = "Dwarfii_Api." + responseClass;
        Response_message = eval(`new Dwarfii_Api.${responseClass}()`);
        Response_message = decodePacket(WsPacket_message.data, eval(`Dwarfii_Api.${responseClass}`));
