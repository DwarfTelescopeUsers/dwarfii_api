/** @module photo_video */
import { telephotoCamera, photoSingleShot, takePhotoCmd, startRecordingCmd, stopRecordingCmd, startTimelapseCmd, stopTimelapseCmd, } from "./api_codes.js";
 ...
 * @returns {Object}
 */
export function takePhoto(camera = telephotoCamera, photoMode = photoSingleShot, count = 1, name = `DWARF_${nowLocalFileName()}`) {
    const options = {
 ...
 * @returns {Object}
 */
export function startTimeLapse(intervalTime, outTime, name = `DWARF_TL_${nowLocalFileName()}`) {
