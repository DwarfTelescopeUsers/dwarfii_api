 ...
 * @returns {Object}
 */
export function takePhoto(camera = telephotoCamera, photoMode = photoSingleShot, count = 1, name = `Photo ${now()}`) {
    const options = {
 ...
 * @returns {Object}
 */
export function startTimeLapse(intervalTime, outTime, name = `Timelapse ${now()}`) {
